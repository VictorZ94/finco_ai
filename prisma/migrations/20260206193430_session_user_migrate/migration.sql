...
-- AddForeignKey
ALTER TABLE "LedgerEntries" ADD CONSTRAINT "LedgerEntries_accountId_fkey" FOREIGN KEY ("accountId") REFERENCES "financial_accounts"("id") ON DELETE CASCADE ON UPDATE CASCADE;
